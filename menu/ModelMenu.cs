...
public class SubMenuOption : MenuOption
{
  ...
  {
    StorePermission.getInstance().MenuManager.OpenSubMenu(player, NextMenu);
  }
...
public class WasdModelMenu
{
  ...
  public string Render()
  {
    ...
    builder.AppendLine($"<font class='fontSize-s' color='#9ee1f0'>{StorePermission.getInstance().Localizer["menu.instruction"]}</font><br>");
